...
JAVA_HOME=/Library/Java/JavaVirtualMachines/openjdk15/Contents/Home nice -n 20 java -jar ~/Downloads/Kicad/freerouting-1.4.4-executable.jar -di . -de rascsi_2p4.bin -do rascsi_2p4.ses -dr rascsi_2p4.rules
